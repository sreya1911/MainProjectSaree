              ...
              <Card className="d-flex flex-row position-relative cart-item">
                ...
                <Card.Body>
                  ...
                  <div className="quantity-control">
                    <Button variant="light" onClick={() => decreaseQuantity(product)} className="cart-button"> - </Button>
                    <span className="quantity">{product.quantity}</span>
                    <Button variant="light" onClick={() => increaseQuantity(product)} className="cart-button"> + </Button>
                    <FaTrash
